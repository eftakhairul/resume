...
\section{Experience}
\resumeHeadingListStart{}
  \resumeQuadHeading{Senior Software Developer}{\textbf{January 2021 -- Present}}
  ...
  {Index Exchange}{Montreal, Canada}
    \resumeItemListStart{}
    \resumeItem {Built and introduced “\textbf{infrastructure telemetry}” metrics, observability and process documentation, resulting in increased reliability and enabling change visibility. Leveraged \textbf{Golang, Grafana} and \textbf{InfluxDB}. }      
      ...
      \resumeItem{Responsible for the enhancement of the core bidding platform based on \textbf{OpenRTB}. Architected and built the “\textbf{native ad}” feature and led integration into Core Biding platform.}
    \resumeItemListEnd{}
...
\resumeQuadHeading{Senior Software Developer}{\textbf{Aug 2015 -- May 2016}}
  {Executable Design Inc.}{Montreal, Canada}
    \resumeItemListStart{}
      \resumeItem{Led the team and establish the technical direction in \textbf{Node.js, MySQL} \& \textbf{OrientDB} for various in-house projects.}
      \resumeItem{Analyzed, architected and implemented various distributed applications.}
    \resumeItemListEnd{}
\resumeQuadHeading{Software Developer}{\textbf{Aug 2014 -- Jun 2015}}
  {IOU Finance Inc.}{Montreal, Canada}
    \resumeItemListStart{}
      \resumeItem{Enhanced and implemented new features to the in-house financial platform Based on \textbf{Ruby on Rails}, while abiding by a Test Driven Development \textbf{(TDD)} process. Maintained platform and pre-existing fixed bugs. }
      \resumeItem{Built CI/CD pipeline with \textbf{Docker} on \textbf{AWS}.}      
    \resumeItemListEnd{}
\resumeHeadingListEnd{}
%---------------------------------------------
