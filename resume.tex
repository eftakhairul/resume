...
\section{Brief}
\small{
Skilled software engineer with over 14 years of professional experience in software architecture and implementation. Specialized in DevOps, Cloud technologies, and distributed architectures.}
%--------------------------------------------
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    ...
    \resumeSectionType{Infrastructure}{:}{Kubernetes, Nomad, Kafka, Terraform, Ansible, Puppet, Packer, Jenkins, AWS, GCP, Azure}
...
\resumeHeadingListStart{}
  ...
  \resumeItemListStart{}
    ...
    \resumeItem{Led the technical initiative and implementation of \textbf{Machine-to-Machine (M2M)} communications leveraging \textbf{OAuth 2.0 Client Credentials Flow}, 
    enabling secure and scalable service-to-service authentication across distributed microservices.}
    \resumeItem{Engineered and enhanced new features to existing core identity microservice based on \textbf{Golang} \& Graph Database \textbf{Amazon Neptune DB}.}
  \resumeItemListEnd{}
  ...
  {National Bank of Canada (NBC)}{Montreal, Canada}
    \resumeItemListStart{}
      ...
      20 internal teams and reduced API integration time by 30\%.}
      \resumeItem{Led, implemented and enhanced multiple new features to the Bank\'s internal applications based on \textbf{Golang}, while abiding by a Test Driven Development \textbf{(TDD)} process. Deployed them on \textbf{Kubernetes}.}
    \resumeItemListEnd{}
  ...
  {Unity Technologies}{Montreal, Canada}
    \resumeItemListStart{}
      ...
      \resumeItem{Architected and led the development of the multiplayer game hosting portion of the Unity Core Apps product line. Optimized the solution to work on bare metal with low latency and six nines uptime.}
      \resumeItem{Constructed a bespoke orchestration tool with \textbf{Nomad}, automating deployment for over 2400 bare-metal servers as well as 5K cloud instances.}
    \resumeItemListEnd{}
  ...
  {Index Exchange}{Montreal, Canada}
    \resumeItemListStart{}
      ...
      \resumeItem{Responsible for the enhancement of the core bidding platform based on \textbf{OpenRTB}. Architected and built the “\textbf{native ad}” feature and led integration into the Core Bidding platform.}
    \resumeItemListEnd{}
  ...
  {Payment Rails Inc. aka Trolley}{Montreal, Canada}
    \resumeItemListStart{}
      ...
      \resumeItem{Led a team of five engineers. Made final decisions on tech stack, architecture and development processes. }
    \resumeItemListEnd{}
  ...
  {Executable Design Inc.}{Montreal, Canada}
    ...
    {IOU Finance Inc.}{Montreal, Canada}
      \resumeItemListStart{}
        \resumeItem{Implemented new feature and refactored the legacy code of their in-house loan processing application based \textbf{Ruby on Rails}.}
        \resumeItem{Automated the CI/CD pipeline based on \textbf{Jenkins \& AWS cloud}.}
      \resumeItemListEnd{}

    \resumeQuadHeading{Software Developer}{\textbf{Jun 2012 -- Jun 2013}}
    {Codemate Ltd}{Dhaka, Bangladesh}
      \resumeItemListStart{}
        \resumeItem{Designed, coded, tested and troubleshooted programs utilizing \textbf{MySQL} \textbf{PHP} with \textbf{Symfony2} and \textbf{Zend Framework 1.11.12}.}
        \resumeItem{Implemented design patterns in the object-oriented design of the application.}
        \resumeItem{Wrote and maintained programming documentation, mentored teammates, and reviewed code of team members.}
      \resumeItemListEnd{}

    \resumeQuadHeading{Software Developer}{\textbf{Feb 2011 -- May 2012}}
    {Right Brain Solution Ltd}{Dhaka, Bangladesh}
      \resumeItemListStart{}
        \resumeItem{Developed and maintained web applications utilizing \textbf{PHP 5.2}, \textbf{CodeIgniter}, and \textbf{Zend Framework} backed by \textbf{MySQL}.}
        \resumeItem{Built and deployed cross-platform mobile applications using \textbf{PhoneGap} and native \textbf{Android}.}
      \resumeItemListEnd{}
\resumeHeadingListEnd{}
%---------------------------------------------
...
\section{Certifications}
  \resumeHeadingListStart{}
    \resumeQuadHeading{AWS Certified Developer -- Associate}{}
