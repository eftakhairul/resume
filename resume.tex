...
\resumeHeadingListStart{}
  ...
  {National Bank (NBC)}{Montreal, Canada}
    \resumeItemListStart{}
      \resumeItem{Implemented multi-tennat private API marketplace based on \textbf{OpenAPI Specification (OAS)}.}
      \resumeItem{Lead, implemented and enhanceed multiple new features to the Bank internal applications based on \textbf{Golang}, while abiding by a Test Driven Development \textbf{(TDD)} process. Deployed them on \textbf{Kubernetes}.}
    \resumeItemListEnd{}
