...
\section{Experience}
\resumeHeadingListStart{}
  \resumeQuadHeading{Senior Software Developer}{\textbf{July 2023 -- Present}}
  {National Bank}{Montreal, Canada}
    \resumeItemListStart{}
      \resumeItem{Implemented multi-tennat private API marketplace based on \textbf{OpenAPI3} specification.}
      \resumeItem{Lead, enhanceed and deployed multiple features of Bank internal tools.}
    \resumeItemListEnd{}
